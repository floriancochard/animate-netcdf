...
- Added feature to show map contours in designer mode
- Added feature to zoom-in on a specific lat/lon location
- Added feature to display land and sea
- Improved designer mode
- Added GIF output format
